      ...
      <div className="min-h-screen flex items-center justify-center bg-[#d1c4e9] h-screen py-[40px] px-[20px] pt-[90px]">
        <div className="w-[90%] max-w-[900px] bg-white rounded-[10px] shadow-[0_10px_30px_rgba(0,0,0,0.1)] overflow-hidden mx-auto">
          <div className="p-[40px]">
            <h2 className="text-[28px] font-bold text-[#4a148c] mb-[5px] text-center">
              Buat Akun Baru
            </h2>
            ...
            {error && (
              <p className="text-red-500 text-center mb-[20px]">{error}</p>
            )}
            ...
            >
              <div className="mb-[10px]">
                <label
                  htmlFor="nik"
                  className="block font-medium mb-[5px] text-[#333]"
                >
                  NIK
                </label>
                <input
              ...
              <div className="mb-[10px]">
                <label className="block font-medium mb-[5px] text-[#333]">
                  Jenis Kelamin
                </label>
