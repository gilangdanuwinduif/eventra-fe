...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const decodedToken: { sub: string; iat: number; exp: number } =
        jwtDecode(token)
        ...
        <div className="flex max-w-screen-md bg-white rounded-[10px] shadow-[0_10px_30px_rgba(0,0,0,0.1)] overflow-hidden mx-auto">
          <div className="flex flex-col md:flex-row p-[50px] gap-[30px]">
            ...
            <div className="flex-1 pl-[40px]">
              <h3 className="text-[24px] font-semibold text-[#4a148c] mb-[5px]">
                Masuk ke Akun
              </h3>
              <p className="text-[#555]">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-[20px]">
                  <label
                    htmlFor="email"
                    className="block font-medium mb-[8px] text-[#333]"
                  >
                    Email atau Username
                  </label>
                  <input
                ...
                <div className="flex justify-between items-center mb-[30px] text-[14px]">
                  ...
                  <a
                    href="#"
                    className="text-[#8c5dff] no-underline font-medium"
                  >
                    Lupa Password?
                  </a>
                </div>
                ...
                <p className="text-center mt-[30px] text-[14px] text-[#555]">
                  Belum punya akun?
                </p>
                <Link
                  to="/register"
