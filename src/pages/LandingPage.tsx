  ...
  return (
    <div>
      ...
      <section className="bg-[#d1c4e9] py-[100px] px-[50px] text-center text-[#4a148c] min-h-[500px] flex flex-col justify-center items-center">
        <h1 className="text-[48px] font-bold mb-[20px] max-w-[800px] leading-[1.2]">Temukan EventTech Terbaik di EventTeh Eventra</h1>
        <p className="text-[18px] font-normal mb-[40px] max-w-[600px] text-[#6a1b9a]">
            ...
            Dapat pengalaman tak terlupakan bersama kami.
        </p>
        <div className="w-full max-w-[600px] relative">
            <span className="absolute left-[20px] top-1/2 -translate-y-1/2 text-[#999] pointer-events-none text-[18px]">🔍</span>
            <input type="text" className="w-full py-[15px] pr-[25px] pl-[50px] border-none rounded-[30px] text-[16px] shadow-[0_4px_15px_rgba(0,0,0,0.1)] outline-none" placeholder="Search" />
        </div>
      </section>
          ...
          <div className="flex justify-center gap-[30px] flex-wrap">
              <div className="w-[280px] bg-white rounded-[10px] overflow-hidden shadow-[0_4px_15px_rgba(0,0,0,0.1)] text-left transition-transform duration-300 hover:-translate-y-[5px] hover:shadow-[0_8px_20px_rgba(0,0,0,0.15)]">
                  <div className="relative">
                      <img src="https://via.placeholder.com/280x180/7e57c2/ffffff?text=EVENT+DRIVE+IN" alt="Event Drive In Senja" className="w-full h-[180px] object-cover block" />
                      <span className="absolute top-[15px] right-[15px] bg-[#8c5dff] text-white py-[4px] px-[10px] rounded-[4px] text-[12px] font-semibold">Kategori</span>
                  </div>
                  <div className="p-[15px]">
                      <p className="text-[14px] text-[#8c5dff] font-medium mb-[5px]">Movies | Drive-In</p>
                      <h3 className="text-[18px] font-semibold mb-[10px] leading-[1.4] text-[#333]">Drive In Senja Back to the...</h3>
      ...
      <footer className="bg-gray-900 text-white py-12 px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Temukan event terbaik di EventTech Eventra. Jelajahi berbagai event musik, olahraga, seni, dan banyak lagi.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors"><i className="fab fa-linkedin-in"></i></a>
            </div>
          </div>
        </div>
